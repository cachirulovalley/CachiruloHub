            ...
            <div class="main table-row clearfix">
                ...
                <div class="main-right table-cell">
                    ...
                    <div class="panel" id="panel">
                        <a href="javascript:void(null)" onClick="hidePanel();" id="closeButton">Volver al mapa</a>
